...
var animatePawState = function (selector) {
    return gsap_1["default"].fromTo(selector, { autoAlpha: 0 }, {
        autoAlpha: 1,
        duration: 0.01,
        repeatDelay: 0.19,
        yoyo: true,
...
var noteElFn = gsap_1["default"].utils.pipe(gsap_1["default"].utils.toArray, gsap_1["default"].utils.shuffle);
...
var notesG3 = noteEls;
var colorizer = gsap_1["default"].utils.random([green, pink, blue, orange, cyan, "#a3a4ec", "#67b5c0", "#fd7c6e"], true);
var rotator = gsap_1["default"].utils.random(-50, 50, 1, true);
var dir = function (amt) { return "".concat(gsap_1["default"].utils.random(["-", "+"]), "=").concat(amt); };
var animateNotes = function (els) {
    ...
    return gsap_1["default"].fromTo(els, {
        autoAlpha: 1,
        y: 0,
        scale: 0
    }, {
